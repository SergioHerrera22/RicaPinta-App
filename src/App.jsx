    ...
    return (
      <div className="min-h-screen w-full bg-app-pattern">
        <div className="mx-auto max-w-350 px-4 pb-8 pt-6 lg:px-8">
          ...
          {/* Barra de métricas siempre visible arriba */}
          <div className="mb-6">
            ...
            <main className="min-w-0">
              ...
              {activeModule === "estadisticas" && (
                <section className="space-y-4">
                  {/* TopBar ya está arriba, solo dashboard aquí */}
                  <Suspense
                    fallback={
              ...
              {activeModule === "pedidos" && (
                <section>
                  <OrdersPanel
                    ...
                    onUpdateNeededQuantity={handleUpdateOrderNeededQuantity}
                    onRemoveOrder={handleRemovePurchaseOrder}
              ...
              {activeModule === "cuenta-corriente" && (
                <section>
                  <CurrentAccountPanel
                    ...
                    clientContacts={clientContacts}
                    onRegisterPayment={handleRegisterAccountPayment}
                  />
                </section>
              )}
